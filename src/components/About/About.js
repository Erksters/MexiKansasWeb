  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "75vw" }}>
        <p>
          MexiKansas.com is a website dedicated to help Chicanos and others understand,
          resolve, and improve personal struggles via storytelling. Many Chicano's have similar experiences and 
          can benefit from reading case-by-case scenarios. The author is from the
          midwest and has shared a few stories anonymously. If you'd
          like to contribute and add a personal experience to this website, then email{" "}
          <a href="emailto:mexikansas1@gmail.com">mexikansas1@gmail.com</a> or contribute via Google Forms. He
        ...
        <p>
          ...
          is not limited to:
          <ul>
            <li className="Topics">Higher-Education as a First-Generation Student</li>
